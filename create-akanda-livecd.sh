...
# The base sets that should be installed on the live cd
SETS="base etc man"
...
WDIR=/tmp/livecdx			# Working directory
...
CLEANUP=yes				# Clean up downloaded files and workdir
...
swap /opt mfs rw,auto,-P/mfsopt 0 0
...
EOF
	...
	date > $WDIR/etc/akanda-livecd-release
