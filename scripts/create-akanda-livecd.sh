...
#      |_| ----------------------Akanda Live CD-
#
# This script creates an Akanda Live CD - powered by OpenBSD and Twisted - and lets you customize it
#
#
# Copyright (c) 2009 Reiner Rottmann. Released under the BSD license.
# Modified for use with Akanda by Murali Raju - murali.raju@dreamhost.com - 2012
#
